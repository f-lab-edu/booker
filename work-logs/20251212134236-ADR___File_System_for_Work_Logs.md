...
author: Antigravity
date: 2025-12-12T13:42:36.617791132
---
...
- **Problem**: `findAll` reads and parses all files in the directory (O(N)). This will become an I/O bottleneck as file count grows.
